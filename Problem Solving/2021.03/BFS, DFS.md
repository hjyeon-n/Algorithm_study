...
고민하다가 풀이 방법을 찾아봤고, 방문한 후에 방문여부를 표시하는 방법이 아니라 일단 큐에 집어넣은 후에 큐에서 값을 빼낼 때 방문 여부를 확인하는 방법으로 풀이했더니 정답처리가 됐다. 후에 방문여부를 표시하는 문제를 풀었던 것 같은데 찾아봐도 잘 모르겠네... 나중에 찾게 되면 수정해야겠다!